    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estilo', models.CharField(choices=[('deportivo', 'Deportivo'), ('formal', 'Formal')], error_messages={'required': '\xbfC\xfaal es el estilo?'}, max_length=9, validators=[django.core.validators.RegexValidator(message='El estilo no es v\xe1lido', regex=b'^deportivo|formal$')])),
                ('tallas', models.CharField(choices=[('27', '27'), ('28', '28'), ('29', '29'), ('30', '30'), ('31', '31'), ('32', '32'), ('33', '33'), ('34', '34'), ('35', '35'), ('36', '36'), ('37', '37'), ('38', '38'), ('39', '39'), ('40', '40'), ('41', '41'), ('42', '42'), ('43', '43')], max_length=2, validators=[django.core.validators.RegexValidator(message='El n\xfamero de tall no es v\xe1lido', regex=b'^2[7-9]|3[0-9]|4[0-3]$')])),
