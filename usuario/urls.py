...
urlpatterns = [
    ...
    url(r'^usuario/admin/cliente/crear$', RegistroCliente.as_view(), name='registrar_cliente'),
    url(r'^usuario/admin/cliente/lista$', ListaCliente.as_view(), name='listar_clientes'),
    url(r'^usuario/admin/cliente/(?P<pk>\d+)/editar$', ActualizacionCliente.as_view(), name='actualizar_cliente'),
