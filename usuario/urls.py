...
urlpatterns = [
    ...
    url(r'^usuario/admin/cuenta/(?P<pk>\d+)/eliminar$', EliminacionCuenta.as_view(), name='eliminar_cuenta'),
    url(r'^usuario/admin/cuenta/lista$', ListaVendedor.as_view(), name='listar_vendedores'),
