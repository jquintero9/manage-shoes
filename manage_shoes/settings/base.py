...
SECRET_KEY = 'b0$+!g9_(n)($e7liazfr=!ark_!7#-e6x&ajf)3kcnkge7)b0'
...
ROOT_URLCONF = 'manage_shoes.urls'
...
WSGI_APPLICATION = 'manage_shoes.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'manage_shoes.sqlite3'),
    }
}
